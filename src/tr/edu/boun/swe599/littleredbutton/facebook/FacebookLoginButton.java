package tr.edu.boun.swe599.littleredbutton.facebook;
...
public class FacebookLoginButton extends Button {
    ...
    private void setButtonText() {
        if (sessionTracker != null && sessionTracker.getOpenSession() != null) {
            setText((logoutText != null) ? logoutText : "Disable Facebook");
        } else {
            setText((loginText != null) ? loginText : "Enable Facebook");
        }
    }
            ...
            if (openSession != null) {
                ...
                if (confirmLogout) {
                    ...
                    if (user != null && user.getName() != null) {
                        message = String.format("Logged in as: %1$s", user.getName());
                    } else {
