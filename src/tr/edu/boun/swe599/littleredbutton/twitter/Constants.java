...
public class Constants {
	...
	public static final String TWITTER_SCHEME = "x-application-littleredbutton-oauth-twitter";
	public static final String TWITTER_CALLBACK_URL = TWITTER_SCHEME + "://callback";
	// Twitter oauth urls
